/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/cloud/src/worker-configuration.d.ts` (hash: c53069c4720d174613463ac40a82004c)
...
interface __BaseEnv_Env {
	...
	EVA_LOCAL_DEV: string;
	EVA_AGENT: DurableObjectNamespace<import("./index").EvaAgent>;
	REMINDER_SCHEDULER: DurableObjectNamespace<import("./index").ReminderScheduler>;
	Sandbox: DurableObjectNamespace<import("./index").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "EvaAgent" | "Sandbox" | "ReminderScheduler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EVA_AUTH_MODE" | "SANDBOX_TRANSPORT" | "EVA_CLOUD_MODEL" | "EVA_EMBEDDING_MODEL" | "EVA_REMINDER_FROM" | "EVA_DEFAULT_SYSTEM_INSTRUCTIONS" | "EVA_API_TOKEN" | "EVA_LOCAL_DEV">> {}
}
