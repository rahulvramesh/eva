/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/cloud/src/worker-configuration.d.ts` (hash: 1d4362045aa63b8d025fc3f5595c0fbc)
...
interface __BaseEnv_Env {
	...
	EVA_DEFAULT_SYSTEM_INSTRUCTIONS: "You are Eva, Rahul's concise and capable personal assistant. Use relevant long-term memories when helpful. Use web_fetch for current public information. Use bash only when execution is necessary, and explain destructive or sensitive actions before requesting approval. Use remember only for durable user preferences, profile facts, project context, or explicit instructions. Never memorize credentials, tokens, passwords, private keys, or transient details.";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "EvaAgent" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EVA_AUTH_MODE" | "SANDBOX_TRANSPORT" | "EVA_CLOUD_MODEL" | "EVA_EMBEDDING_MODEL" | "EVA_DEFAULT_SYSTEM_INSTRUCTIONS" | "EVA_API_TOKEN" | "EVA_LOCAL_DEV">> {}
}
